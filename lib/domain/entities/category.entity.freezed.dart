...
mixin _$CategoryEntity {
  ...
  int get especial => throw _privateConstructorUsedError;
...
class _$CategoryEntityImpl implements _CategoryEntity {
  ...
  @override
  String toString() {
    return 'CategoryEntity(adulto: $adulto, background: $background, card: $card, cardIos: $cardIos, especial: $especial, icono: $icono, id: $id, name: $name, ott: $ott, predefinido: $predefinido)';
  }
...
abstract class _CategoryEntity implements CategoryEntity {
  const factory _CategoryEntity(
      ...
      required final int especial,
      required final String icono,
      required final String id,
      required final String name,
      required final int ott,
      required final String predefinido}) = _$CategoryEntityImpl;
