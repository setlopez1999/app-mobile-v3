...
mixin _$Settings {
  ...
  @override
  String toString() {
    return 'Settings(terms: $terms, policies: $policies, planFreeSelected: $planFreeSelected)';
  }
}
...
extension SettingsPatterns on Settings {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String terms, String policies, String planFreeSelected)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _Settings() when $default != null:
        return $default(_that.terms, _that.policies, _that.planFreeSelected);
      case _:
        return orElse();
    }
  }
